...
export const metadata: Metadata = buildStaticPageMetadata({
  ...
  description: "Terms for using The AI Pit, including the AI simulation acknowledgement and OpenRouter key handling.",
  path: "/terms",
  index: false,
  follow: true,
});
    ...
    <main className="legal-page">
      <div className="legal-shell">
        ...
        <div className="legal-copy">
          ...
          <p>
            OpenRouter requests are routed through The AI Pit&apos;s server-side proxy. Your OpenRouter API key is stored
            in this browser&apos;s localStorage so it can be reused after reloads, and it transits the proxy so OpenRouter
            can complete your request using your OpenRouter account.
          </p>
          <p>
