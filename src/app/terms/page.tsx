...
export const metadata: Metadata = buildStaticPageMetadata({
  ...
  description: "Terms for using The AI Pit, including the AI simulation acknowledgement and hosted OpenRouter access.",
  path: "/terms",
  index: false,
  follow: true,
});
      ...
      <div className="legal-shell">
        ...
        <div className="legal-copy">
          ...
          <p>
            ...
            OpenRouter API key, it is stored in this browser&apos;s localStorage so it can be reused after reloads, and it
            transits the proxy so OpenRouter can complete your request using your OpenRouter account. If you use hosted
            OpenRouter access, debate content is processed through the proxy and The AI Pit&apos;s OpenRouter account.
          </p>
          <p>
