        ...
        <div className="legal-copy">
          ...
          <section id="privacy" className="legal-section">
            ...
            <p>
              ...
              loads. Onboarding includes privacy preferences for configured Google Analytics and app-level Sentry
              reporting, and those choices are stored in this browser. Outside the European Union, telemetry may load by
              default unless you have already declined it in this browser. Turning privacy preferences off keeps the app
              functional and disables Google Analytics and app-level Sentry error reporting where the app can read your
